...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝╚═╝ ╚═════╝ ╚═════╝ ╚═╝     ╚═╝╚═╝ ╚═════╝ 
 ╔╦╗╔═╗═╗ ╦╔═╗  ╔═╗╦═╗╔═╗ ╦╔═╗╔═╗╔╦╗  ╦ ╦╔═╗╔═╗╦╔═╔═╗╦═╗  ╔╦╗╔═╗╔═╗╔╦╗  
  ║ ║  ╔╩╦╝╚═╗  ╠═╝╠╦╝║ ║ ║║╣ ║   ║   ╠═╣╠═╣║  ╠╩╗║╣ ╠╦╝   ║ ║╣ ╠═╣║║║  
  ╩ ╚═╝╩ ╚═╚═╝  ╩  ╩╚═╚═╝╚╝╚═╝╚═╝ ╩   ╩ ╩╩ ╩╚═╝╩ ╩╚═╝╩╚═   ╩ ╚═╝╩ ╩╩ ╩  
 \033[1;32m+ -- -- +=[ G0Rp0Ork0  tcxsproject.com.br\033[1;m
 \033[1;32m+ -- -- +=[ 331 Tools \033[1;m


\033[1;91m[W] Antes de atualizar seu sistema, remova todos os repositórios Kali-linux para evitar qualquer tipo de problema.\033[1;m
		''')
		def inicio1():
			while True:
				print ('''
1) Adicionar repositoriod do Kali e atualizar
2) Ver categorias
3) Instalar o Menu Classico
4) Instalar o menu Kali
5) Ajuda
			...
			''')
				...
				while opcion0 == "1":
					print ('''
1) Adicionar os repositorios do kali
2) Atualizar (update)
3) Remover todos repositorios do kali
4) Ver o conteudo de sources.list 
					...
					if repo == "1":
						...
						cmd2 = os.system("echo '# Kali linux repositories | Added by G0Rp0\ndeb http://http.kali.org/kali kali-rolling main contrib non-free' >> /etc/apt/sources.list")
					elif repo == "2":
						...
						delete_list = ["# Kali linux repositories | Added by G0Rp0\n", "deb http://http.kali.org/kali kali-rolling main contrib non-free\n"]
						fin = open(infile)
						...
						fin.close()
						fout.close()
						print ("\033[1;31m\nTodos os repositórios kali linux foram excluídos !\n\033[1;m")
					elif repo == "back":
						inicio1()
					elif repo == "gohome":
						inicio1()
						...
						print ("\033[1;31mEste comando é invalido!\033[1;m") 					
						

				if opcion0 == "3":
					print (''' 
O ClassicMenu Indicator é um applet da área de notificação (indicador de aplicativo) para o painel superior do ambiente de área de trabalho Unity do Ubuntu.

Ele fornece uma maneira simples de obter um menu clássico de aplicativos no estilo GNOME para aqueles que preferem isso no menu de traços do Unity.

Como o menu clássico do GNOME, ele inclui jogos e aplicativos do Wine, se você tiver os instalados.

Para mais informações, visite: http://www.florian-diesch.de/software/classicmenu-indicator/

''')
					repo = raw_input("\033[1;32mDeseja instalar o classic menu ? [y/n]> \033[1;m")
					if repo == "y":
					...
					repo = raw_input("\033[1;32mDesejar instalar o menu do Kali-linux ? [y/n]> \033[1;m")
					if repo == "y":
...
0) All
			 ...
			 ''')
						print ("\033[1;32mSelecione uma categoria ou pressione (0) para instalar todas as ferramentas Kali linux .\n\033[1;m")
...
0) Install all Information Gathering tools
						...
						''')
							print ("\033[1;32mInsira o número da tool para instalar .\n\033[1;m")
...
0) Install all Vulnerability Analysis tools
						...
						''')
							print ("\033[1;32mInsira o numero da tool para instalar .\n\033[1;m")
							opcion2 = raw_input("\033[1;36mkat > \033[1;m")
							if opcion2 == "1":
...
2) Squid3
		...
		print ("Valeu bro boa hackeada, ve se owna nasa e agradece ao G0Rp0 da TCXS Project por este hack existir!")
	except Exception:
